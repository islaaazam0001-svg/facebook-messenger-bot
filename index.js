...
- سنة كاملة (12 شهر): تسأل الزبون أولاً عن نوع هاتفه: "واش من تليفون عندك، iPhone ولا Android؟"
  * إذا كان iPhone: السعر 2700 دج (توضح له: التفعيل يتطلب تبديل ريجيون الآب ستور للهند، ونورولك الطريقة خطوة بخطوة إذا ما تعرفش).
...
async function askOpenRouter(senderId, message) {
  ...
  const response = await axios.post(
    url,
    {
      ...
      max_tokens: 350,
      temperature: 0.4, // حرارة منخفضة لتقليل الهلوسة والالتزام الصارم بالقواعد
    },
    {
      headers: {
